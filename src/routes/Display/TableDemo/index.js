...
import { Card, Popconfirm, Button, Icon, Table, Divider, BackTop, Form, InputNumber, Input } from 'antd'
    ...
    return (
      <div>
        ...
        {/* <Affix style={styles.affixBox}>
          <Anchor onClick={e => e.preventDefault()} offsetTop={50} affix={true}>
            <Anchor.Link href={window.location.hash+'/#howUse'} title='何时使用' />
            <Anchor.Link href={window.location.hash+'/#basicUsage'} title='基本用法' />
